...
import { Activity, AlertTriangle, ChevronRight, Search, Filter } from 'lucide-react'
...
export default function StartupsPage() {
    ...
    return (
        <div className="animate-fade-in">
            <div className="mb-10">
                <h1 className="font-outfit text-4xl font-extralight tracking-tight mb-2">All Startups</h1>
                <p className="text-[#606060] font-light">Complete directory of your portfolio companies.</p>
            </div>
